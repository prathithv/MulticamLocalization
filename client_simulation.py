...
while True:
    ...
    current_location[2] = current_location[2] + incremental_list[random.randint(0,5)]
    current_location[4] = current_location[4] + incremental_list[random.randint(0,5)]
    if (current_location[2] > 1) or (current_location[4] > 1):
        current_location = [client_number, classes_detected, 0, 0.84, 0, 0] 
